                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                <table class="datatable-1 table table-bordered table-striped display" width="100%">
                                    ...
                                    <tbody id="getUsersFromDb">
                                    </tbody>
                                </table>
                            </div>

                        <!--For Delete a Query Record-->
                            <div id="users_DelModal" class="modal fade" role="dialog">
                                <div class="modal-dialog modal-sm">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <input type="button" name="btn-users-delete" id="btn-users-delete" class="btn btn-success" value="Confirm">
                            ...
                            <div id="users_delete_AckModal" class="modal fade" role="dialog">
                                <div class="modal-dialog modal-sm">
